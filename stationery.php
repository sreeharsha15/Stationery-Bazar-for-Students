            ...
            <div class="column1">
              <div class="card1">
                ...
                <div class="container1">
                  ...
                  <div style="width:100%;">
                      <form method="POST" action="stationery.php">
                        <input type="hidden" name="ad_id" value="<?php echo $row['id']; ?>">
                        <button class="btn1" type="submit" name="scnt_sell" >ContactSeller</button>
                      </form>
                      <form method="POST" action="stationery.php">
                        <input type="hidden" name="rep_inp1" value="<?php echo $row['id']; ?>">
                        <button  class="btn1" type="submit" name="sreport1">ReportAD</button>
                      </form>
                      </div>
                  </div>
                </div>
