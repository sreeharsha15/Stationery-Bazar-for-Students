      ...
      <main class="grid">
        <article>
          ...
          <div class="text">
            ...
            <button onclick="location.href='apron.php';">Buy Aprons</button>
          </div>
        </article>
        ...
        <article>
          ...
          <div class="text">
            ...
            <button onclick="location.href='books.php';">Buy Books</button>
          </div>
        </article>
        ...
        <article>
          ...
          <div class="text">
            ...
            <button onclick="location.href='stationery.php';">Buy stationery</button>
          </div>
        </article>
      </main>
    </div>
    <div class="bottom">
      <div class="col1"><a class="Link"href="aboutus.php">AboutUs</a>
      </div>
