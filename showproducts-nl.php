...
<html lang="en" dir="ltr">
  ...
  <body>
    <nav class="navbar  navbar-expand-lg sticky-top navbar-dark "style="background-color:#0e49b5">
    ...
    <div class="container">
      <main class="grid">
        <article>
          <img src="apron.png" alt="apron" width=100%/>
          <div class="text">
            <h3>Aprons</h3>
            <p>
              Click on the button below to see the aprons which are on sale!
            </p>
            <button onclick="location.href='apron-nl.php';">Buy Aprons</button>
          </div>
        </article>


        <article>
          <img src="book.png" alt="books" width=100%/>
          <div class="text">
            <h3>Books</h3>
            <p>
              Click on the button below to see the books which are on sale!
            </p>
            <button onclick="location.href='books-nl.php';">Buy Books</button>
          </div>
        </article>

        <article>
          <img src="stn.png" alt="stationery" width="100%" />
          <div class="text">
            <h3>Stationery</h3>
            <p>
              Click on the button below to see the stationery which are on sale!
            </p>
            <button onclick="location.href='stationery-nl.php';">Buy stationery</button>
          </div>
        </article>
      </main>
    </div>
