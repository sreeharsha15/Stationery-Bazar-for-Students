    ...
    <table class="table table-striped table-hover table-responsive" id="td">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td id="td"><img class="zoom"src="<?php echo $row["image"]; ?>" width="100px" height="100px" alt="apronimg"></td>
          <form  action="adminaccad.php" method="POST">
            <input type="hidden" name='uemail' value="<?php echo $row['email']; ?>"/>
            <input type="hidden" name="apid" value="<?php echo $row['id']; ?>"/>
            <input type='hidden' name='ap_ty' value="<?php echo $row['type']; ?>"/>
            <td><button type="submit" class="btn btn-outline-success btn-sm" name='adminaccept'> Y </button></td>
            <input type="hidden" name="idap" value="<?php echo $row['id']; ?>"/>
            <td><button type="submit" class="btn btn-outline-danger btn-sm" name='adminreject'> X </button></td>
          </form>
        </tr>
        <?php
      }
